...
def main45(pic, model, t1, t2):
    ...
    for detection in objs:
        ...
        colors.append(color)
        coco_class.append(coco_classes[class_index // 70])

    indices = cv2.dnn.NMSBoxes(boxes, confidences, t1, t2)
    #print(indices)
...
if __name__ == '__main__':
    model = keras.models.load_model("C:/Users/Meir/Downloads/model_finalyolo77-20230313T214546Z-001/model_finalyolo77")
    main45("C:/Users/Meir/Downloads/vase2.jpeg", model)
